...
import "./interfaces/IRTGRToken.sol";

import "hardhat/console.sol";

contract RTGRToken is IRTGRToken, Ownable, Initializable {
    ...
    string constant private sZeroAddress = "RCRSS: Zero address";
    string constant private sExceedsBalance = "RCRSS: Exceeds balance";
    ...
    function victimsLen () external override view returns (uint256) {
