...
import "../XTGRToken.sol";

import "./IXDAOFarmTypes.sol";
...
interface IXDAOFarm {
    ...
    function feeRates(SessionType sessionType) external view returns (uint32, uint32, uint32, uint32);
    ...
    event SetTreasuryAddress(address previousTreasury, address newTreeausery);
    ...
    function setTGRReferral(address _crssReferral) external;
    function setReferralCommissionRate(uint256 _referralCommissionRate) external;
    function dailyPatrol() external returns (bool done);
}
