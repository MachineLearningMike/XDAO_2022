...
interface LiquidityControlInterface extends ethers.utils.Interface {
  functions: {
...
export class LiquidityControl extends BaseContract {
  ...
  interface: LiquidityControlInterface;
