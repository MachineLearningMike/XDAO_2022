...
interface ICrossPairInterface extends ethers.utils.Interface {
  functions: {
    ...
    "setNodes(address,address,address)": FunctionFragment;
  ...
  decodeFunctionResult(functionFragment: "setNodes", data: BytesLike): Result;
...
export class ICrossPair extends BaseContract {
