...
import type { ICrossFarm, ICrossFarmInterface } from "../ICrossFarm";
...
export class ICrossFarm__factory {
  static readonly abi = _abi;
  static createInterface(): ICrossFarmInterface {
    return new utils.Interface(_abi) as ICrossFarmInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): ICrossFarm {
    return new Contract(address, _abi, signerOrProvider) as ICrossFarm;
  }
}
