...
interface XDAOFarmInterface extends ethers.utils.Interface {
  functions: {
    ...
    "getSubPooledTGR(uint256,address)": FunctionFragment;
    ...
    "setTGRReferral(address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "getSubPooledTGR",
  ...
  encodeFunctionData(
    functionFragment: "setTGRReferral",
    values: [string]
  ): string;
  encodeFunctionData(
...
export class XDAOFarm extends BaseContract {
