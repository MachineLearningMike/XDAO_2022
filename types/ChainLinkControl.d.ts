...
interface ChainLinkControlInterface extends ethers.utils.Interface {
  functions: {
...
export class ChainLinkControl extends BaseContract {
  ...
  interface: ChainLinkControlInterface;
